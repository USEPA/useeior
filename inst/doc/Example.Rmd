...
model_list <- list("USEEIOv2.0.1" = model)
```
...
p1 <- heatmapSectorRanking(model, matrix = result$LCIA_d, indicators,
                           sector_to_remove = "", N_sector = 20, x_title = "US production demand & direct perspective")
p2 <- heatmapSectorRanking(model, matrix = result$LCIA_f, indicators,
                           sector_to_remove = "", N_sector = 20, x_title = "US consumption demand & final perspective")
